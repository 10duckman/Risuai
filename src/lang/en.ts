export const languageEnglish = {
    ...
    lorebookExportEstimate: (chunks:number) => `${chunks} chunks, about ${chunks < 2 ? 2 : chunks * 2} min`,
    ...
    lorebookExportChars: (n:number) => `${n} chars`,
    lorebookExportAlwaysOn: "always active",
    ...
    lorebookExportTargetGone: "The target chat no longer exists, so nothing was added.",
