export const languageKorean = {
    ...
    "lorebookExportEstimate": (chunks:number) => `${chunks}구간, 약 ${chunks < 2 ? 2 : chunks * 2}분`,
    ...
    "lorebookExportChars": (n:number) => `${n}자`,
    "lorebookExportAlwaysOn": "상시 활성",
    "lorebookExportCategory": {
        "person": "인물",
        "place": "장소",
        "state": "관계",
        "object": "사물",
    },
    "lorebookExportTargetGone": "대상 채팅이 사라져 아무것도 추가하지 않았습니다.",
    ...
    "syncFromServerStale": "메시지가 변경되어 동기화할 수 없습니다. 다시 시도하세요.",
